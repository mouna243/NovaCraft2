...
<nav class="fixed w-[100%] flex justify-between p-5 bg-purple-300/40 z-50 shadow-lg shadow-[#504f4f65]">
    ...
    <div class="flex w-auto gap-2 justify-between ">
        ...
        <?php if ($situ === true): ?>
            ...
            <button href="logout" class='border-[3px] border-white p-2 w-[100px] h-[50px] rounded-[20px] bg-purple-600 text-white hover:bg-purple-800'><a href="logout"><i class='fa-solid fa-arrow-right-from-bracket'></i></a></button>
