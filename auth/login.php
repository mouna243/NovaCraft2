...
<body>
    ...
    <div class="relative h-[100vh] flex items-center justify-center z-40">
        <form action="" method="POST"
            ...
            <label for="email" class="text-[#e9d2fb]">E-mail</label>
            <input
                class="border-b-2 border-[#c471f8] w-[300px] rounded-[10px] p-2 focus:outline-none bg-[#fff0] focus:bg-[#fff0]"
                type="text" placeholder="Votre email" type="email" name="email" id="email">
            <label for="msg" class="text-[#e9d2fb]">Passworde</label>
            <input type="password" placeholder="enter le mot de pass"
                class="border-b-2 rounded-[10px] p-2 w-[300px] border-[#c471f8] focus:outline-none  focus:bg-[#fff0] bg-[#fff0] value:text-white" name="password">
            <button type="submit"
...
<?php
include __DIR__ . "/../auth/loginsyn.php";
?>
