...
if (empty($_POST["name"]) || empty($_POST["email"]) || empty($_POST["password"])) {
    ...
    echo $emailcheck;
    if ($emailcheck === 0) {
        echo "<p id='flashmessage' class ='absolute top-1/4 bg-[#f889515f] text-[#650f00] border-[10px] rounded-[40px] p-[10px] text-[20px]'>respecter cette écriture \"exemple@gmail.com\" </p>";
        return;
    }
    if(strlen($_POST["password"]) < 6 ){
     echo "<p id='flashmessage' class ='absolute top-1/4 bg-[#f889515f] text-[#650f00] border-[10px] rounded-[40px] p-[10px] text-[20px]'>enter un password plus que 6 caratères </p>";
    }
}
?>
