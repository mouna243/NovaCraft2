...
<img src="../asset/signin.gif" alt="bg" class="absolute w-full h-full z-1">
<div class="relative h-full flex items-center justify-center z-40">
    ...
    <form action="" method="POST"
        ...
        <label for="msg" class="text-[#e9d2fb]">PassWord</label>
        <input type="password" placeholder="enter le mot de pass"
            class="border-b-2 rounded-[10px] p-2 w-[300px] border-[#719af8] text-[white] focus:outline-none  focus:bg-[#fff0] bg-[#fff0]" name="password" id="password">
        <button type="submit"
